...
export default function App() {
  ...
  const search = async () => {
    ...
    if (!addr) {
      Alert.alert("Missing address", "Enter a Solana wallet address first.");
      return;
    }
  ...
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.screen}>
        ...
        <Text style={s.subtitle}>Enter a solana address to view details</Text>
